...
package cc.cflags.nixitch.parser;

import com.intellij.lang.PsiBuilder;
import com.intellij.lang.PsiBuilder.Marker;
import static cc.cflags.nixitch.psi.NixTypes.*;
import static cc.cflags.nixitch.psi.NixParserUtil.*;
...
public class NixParser implements PsiParser {
  ...
  public static boolean add_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _LEFT_, "<add expr>");
    r = add_op(b, l + 1);
    r = r && factor(b, l + 1);
  ...
  public static boolean attr_assign(PsiBuilder b, int l) {
    ...
    boolean r, p;
    Marker m = enter_section_(b, l, _NONE_, "<attr assign>");
    r = attr_path(b, l + 1);
    r = r && consumeToken(b, ASSIGN);
    p = r; // pin = 2
    r = r && expr(b, l + 1);
    exit_section_(b, l, m, ATTR_ASSIGN, r, p, null);
    return r || p;
  }
  ...
  public static boolean attr_path(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<attr path>");
    r = attr(b, l + 1);
    r = r && attr_path_1(b, l + 1);
    exit_section_(b, l, m, ATTR_PATH, r, false, null);
    return r;
  }
  ...
  public static boolean attrs(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, ATTRS, true, false, null);
    return true;
  }
  ...
  public static boolean binds(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<binds>");
    r = binds_0(b, l + 1);
    int c = current_position_(b);
    while (r) {
    ...
    exit_section_(b, l, m, BINDS, r, false, null);
    return r;
  }
  ...
  public static boolean bool_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _LEFT_, "<bool expr>");
    r = bool_op(b, l + 1);
    r = r && logical(b, l + 1);
  ...
  public static boolean call_args(PsiBuilder b, int l) {
    ...
    exit_section_(b, l, m, CALL_ARGS, r, p, null);
    return r || p;
  }
  ...
  public static boolean expr_app(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<expr app>");
    r = expr_select(b, l + 1);
    int c = current_position_(b);
    while (r) {
    ...
    exit_section_(b, l, m, EXPR_APP, r, false, null);
    return r;
  }
  ...
  public static boolean expr_function(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<expr function>");
    ...
    exit_section_(b, l, m, EXPR_FUNCTION, r, false, null);
    return r;
  }
  ...
  public static boolean expr_if(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<expr if>");
    r = expr_if_0(b, l + 1);
    if (!r) r = expr_op(b, l + 1);
    exit_section_(b, l, m, EXPR_IF, r, false, null);
    return r;
  }
  ...
  public static boolean expr_list(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b, l, _NONE_, "<expr list>");
    int c = current_position_(b);
    while (true) {
      if (!expr_select(b, l + 1)) break;
    ...
    exit_section_(b, l, m, EXPR_LIST, true, false, null);
    return true;
  }
  ...
  public static boolean expr_op(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<expr op>");
    r = expr_op_0(b, l + 1);
    if (!r) r = expr_op_1(b, l + 1);
    exit_section_(b, l, m, EXPR_OP, r, false, null);
    return r;
  }
  ...
  public static boolean expr_select(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<expr select>");
    r = expr_simple(b, l + 1);
    r = r && expr_select_1(b, l + 1);
    exit_section_(b, l, m, EXPR_SELECT, r, false, null);
    return r;
  }
  ...
  public static boolean expr_simple(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<expr simple>");
    ...
    exit_section_(b, l, m, EXPR_SIMPLE, r, false, null);
    return r;
  }
  ...
  public static boolean formal(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<formal>");
    r = consumeToken(b, ID);
    if (!r) r = formal_1(b, l + 1);
    if (!r) r = consumeToken(b, ELLIPSIS);
    exit_section_(b, l, m, FORMAL, r, false, null);
    return r;
  }
  ...
  public static boolean formals(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<formals>");
    r = formal(b, l + 1);
    r = r && formals_1(b, l + 1);
    exit_section_(b, l, m, FORMALS, r, false, null);
    return r;
  }
  ...
  public static boolean ind_string_parts(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b, l, _NONE_, "<ind string parts>");
    int c = current_position_(b);
    while (true) {
    ...
    exit_section_(b, l, m, IND_STRING_PARTS, true, false, null);
    return true;
  }
  ...
  public static boolean logical(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<logical>");
    r = relative(b, l + 1);
    r = r && logical_1(b, l + 1);
    exit_section_(b, l, m, LOGICAL, r, false, null);
    return r;
  }
  ...
  public static boolean nix_init(PsiBuilder b, int l) {
    ...
    r = p && consumeToken(b, RCURLY) && r;
    exit_section_(b, l, m, NIX_INIT, r, p, null);
    return r || p;
  }
  ...
  public static boolean path_stmt(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<path stmt>");
    r = consumeToken(b, PATH);
    if (!r) r = consumeToken(b, HPATH);
    if (!r) r = consumeToken(b, SPATH);
    if (!r) r = literal_simple_string(b, l + 1);
    exit_section_(b, l, m, PATH_STMT, r, false, null);
    return r;
  }
  ...
  public static boolean pure_bind(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<pure bind>");
    r = pure_bind_0(b, l + 1);
    int c = current_position_(b);
    while (r) {
    ...
    exit_section_(b, l, m, PURE_BIND, r, false, null);
    return r;
  }
  ...
  public static boolean rel_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _LEFT_, "<rel expr>");
    r = rel_op(b, l + 1);
    r = r && relative(b, l + 1);
    exit_section_(b, l, m, REL_EXPR, r, false, null);
    return r;
  }
  ...
  public static boolean relative(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<relative>");
    r = factor(b, l + 1);
    r = r && relative_1(b, l + 1);
    exit_section_(b, l, m, RELATIVE, r, false, null);
    return r;
  }
  ...
  public static boolean require_expr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<require expr>");
    r = require_expr_0(b, l + 1);
    r = r && paths_assign(b, l + 1);
    exit_section_(b, l, m, REQUIRE_EXPR, r, false, null);
    return r;
  }
  ...
  public static boolean string_attr(PsiBuilder b, int l) {
    ...
    boolean r;
    Marker m = enter_section_(b, l, _NONE_, "<string attr>");
    r = consumeToken(b, STR);
    if (!r) r = nix_init(b, l + 1);
    exit_section_(b, l, m, STRING_ATTR, r, false, null);
    return r;
  }
  ...
  public static boolean string_parts(PsiBuilder b, int l) {
    ...
    Marker m = enter_section_(b, l, _NONE_, "<string parts>");
    int c = current_position_(b);
    while (true) {
    ...
    exit_section_(b, l, m, STRING_PARTS, true, false, null);
    return true;
  }
